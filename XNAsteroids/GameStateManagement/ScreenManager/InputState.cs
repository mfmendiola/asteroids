...
namespace GameStateManagement
{
    ...
    public class InputState
    {
        ...
        /// <summary>
        /// Checks for a "Ship Fire" input action, from any player,
        /// on either keyboard or gamepad.
        /// </summary>
        public bool ShipFire
        {
            get
            {
                return IsNewKeyPress(Keys.Space) || IsKeyHeld(Keys.Space) ||
                       IsNewButtonPress(Buttons.A) || IsButtonHeld(Buttons.A);
            }
        }

        /// <summary>
        /// Checks for a "Ship Turn Left" input action, from any player,
        /// on either keyboard or gamepad.
        /// </summary>
        public bool ShipTurnLeft
        {
            get
            {
                return IsNewKeyPress(Keys.A) || IsKeyHeld(Keys.A) ||
                       IsNewButtonPress(Buttons.DPadLeft) || IsButtonHeld(Buttons.DPadLeft) ||
                       IsNewButtonPress(Buttons.LeftThumbstickLeft) || IsButtonHeld(Buttons.LeftThumbstickLeft);
            }
        }
        ...
        /// <summary>
        /// Checks for a "Ship Turn Right" input action, from any player,
        /// on either keyboard or gamepad.
        /// </summary>
        public bool ShipTurnRight
        {
            get
            {
                return IsNewKeyPress(Keys.D) || IsKeyHeld(Keys.D) ||
                       IsNewButtonPress(Buttons.DPadRight) || IsButtonHeld(Buttons.DPadRight) ||
                       IsNewButtonPress(Buttons.LeftThumbstickRight) || IsButtonHeld(Buttons.LeftThumbstickRight);
            }
        }


        /// <summary>
        /// Checks for a "Ship Move" input action, from any player,
        /// on either keyboard or gamepad.
        /// </summary>
        public bool ShipMove
        {
            get
            {
                return IsNewKeyPress(Keys.W) || IsKeyHeld(Keys.W) ||
                       IsNewButtonPress(Buttons.DPadUp) || IsButtonHeld(Buttons.DPadUp) ||
                       IsNewButtonPress(Buttons.LeftThumbstickUp) || IsButtonHeld(Buttons.LeftThumbstickUp);
            }
        }


        /// <summary>
        /// Checks for a "Ship Reverse" input action, from any player,
        /// on either keyboard or gamepad.
        /// </summary>
        public bool ShipReverse
        {
            get
            {
                return IsNewKeyPress(Keys.S) || IsKeyHeld(Keys.S) ||
                       IsNewButtonPress(Buttons.DPadDown) || IsButtonHeld(Buttons.DPadDown) ||
                       IsNewButtonPress(Buttons.LeftThumbstickDown) || IsButtonHeld(Buttons.LeftThumbstickDown);
            }
        }
        ...
        /// <summary>
        /// Helper for checking if a button was held during this update,
        /// by any player.
        /// </summary>
